...
import { SelectNixAccountModalComponent } from './select-nix-account-modal.component';


describe('SelectNixAccountModalComponent', () => {
  let component: SelectNixAccountModalComponent;
  let fixture: ComponentFixture<SelectNixAccountModalComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SelectNixAccountModalComponent);
